...
<head>
<title>Steven Roth - The Official Website of Steven Roth</title>
...
<div id="content">
<div id="space"></div>
<?php include($_SERVER['DOCUMENT_ROOT'].'/blocks/home-slider.php'); ?>
<?php include($_SERVER['DOCUMENT_ROOT'].'/blocks/home-video.php'); ?>
...
<?php include($_SERVER['DOCUMENT_ROOT'].'/blocks/home-facebook.php'); ?>
<?php include($_SERVER['DOCUMENT_ROOT'].'/blocks/home-twitter.php'); ?>
</div>


<div id="split_sections" style="margin-top:48px;">
<?php include($_SERVER['DOCUMENT_ROOT'].'/blocks/home-blog.php'); ?>
<?php include($_SERVER['DOCUMENT_ROOT'].'/blocks/home-store.php'); ?>
</div>

</div>
<div id="title1" style="background-image:url(/images/titles/instagram.png);background-position:center center;background-repeat:no-repeat;"></div>
<?php include($_SERVER['DOCUMENT_ROOT'].'/blocks/instagram.php'); ?>
