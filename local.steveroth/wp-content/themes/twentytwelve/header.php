...
<body <?php body_class(); ?>>
	<div id="menu">
	 <div id="menu_center">
	  <div id="header">
	   <div id="header_btns">	
	    <a href="/category/blog"><div id="header_btn" style="margin-top:28px;float:left;text-align:right;padding-right:10px;color:#ffffff;text-shadow: 0px -1px 0px #000000;font-style:italic;background-image: url(../images/other/menu_dots.png);background-position:left -1px;background-repeat:repeat;background-color:#999;width:170px;">Blog</div></a>
	   ...
	   <div id="header_btns">
	    <a href="/category/press"><div id="header_btn" class="menu" style="margin-top:28px;float:right;text-align:left;padding-left:10px;">Press</div></a>
