...
<div id="wrapper">
 <div id="content">
  <div id="space"></div>
  <div id="content_title" style="background-image:url(/wp-content/themes/twentytwelve/images/titles/sub-page/tour.png);background-position:left center;background-repeat:no-repeat;"></div>
  <div id="content_space">   
  <div id="tours_page">
  <?php include($_SERVER['DOCUMENT_ROOT'].'/wp-content/themes/twentytwelve/blocks/home-tours.php'); ?>
   </div></div>
