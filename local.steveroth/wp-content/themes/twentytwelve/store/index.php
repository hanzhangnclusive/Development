...
<div id="wrapper">
 <div id="content">
  <div id="space"></div>
  <div id="content_title" style="background-image:url(../images/titles/sub-page/store.png);background-position:left center;background-repeat:no-repeat;"></div>
  <div style="height: 480px;width: 939px;margin-left: 30px;background: url(../images/store/1.jpg);"></div>
  <div id="content_space"></div></div>
