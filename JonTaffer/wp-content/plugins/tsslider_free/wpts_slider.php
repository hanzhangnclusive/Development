<?php
/*
	Plugin Name: Ts slider (Free Version)
	Plugin URI: http://www.themeshock.com
	Description: Slider plugin by Themeshock
	Version: 1.0
	Author: Theme Shock
...
function ts_make_slider_menu() {
		...
		$na_plu_can='Slidershock plugin by Themeshock (Free version)';//name plugin canonical
		add_menu_page(
			__($na_plu_can),
			__($na_plu_can), 
  ...
  <h2>Slidershock plugin by themeshock</h2> 
    ...
    <div class="alert alert-block">
       ...
       <ul class="ts_sld_ban">
	       <li>
            <h3>
              <i class="icon-paper-clip" style="color: #CEE"></i>
          ...
          <li>
        	<h3>
            <i class="icon-resize-small" style="color: #CDE"></i>
            ...
            <p>Since the slider is fully responsive, you won't need to worry about your slider stop working on small screen devices.</p>
					...
					<li>
            <h3>
              <i class="icon-magic" style="color: #D06"></i>
            ...
            <p>Pick one from 31 available effects or let them be random.</p>
					...
					<li>
            <h3>
              <i class="icon-edit" style="color: #00A10A"></i>
